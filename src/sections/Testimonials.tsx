  ...
  return (
    <section className="py-20 md:py-24">
      <div className="container">
        ...
        <p className="text-white/70 text-lg md:text-xl text-center max-w-sm mt-5 tracking-tight mx-auto">Our revolutionary AI SEO tools have transformed our client's strategies.</p>
